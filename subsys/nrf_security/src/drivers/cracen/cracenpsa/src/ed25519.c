...
int ed25519_calculate_r(struct sxhash hashopctx, char *workmem, const uint8_t *message, size_t message_length, int prehash)
{
	int status;
...
int ed25519_calculate_k(struct sxhash hashopctx, char *workmem, char *pointr, const char *message, size_t message_length, int prehash)
{
...
int ed25519_sign_internal(const uint8_t *priv_key, char *signature, const uint8_t *message, size_t message_length, int prehash)
{
	char workmem[160];
	struct sxhash hashopctx;
...
int ed25519_sign(const uint8_t *priv_key, char *signature, const uint8_t *message, size_t message_length)
{
	return ed25519_sign_internal(priv_key, signature, message, message_length, 0);
}

int ed25519ph_sign(const uint8_t *priv_key, char *signature, const uint8_t *message, size_t message_length, int ismessage)
{
	...
	if (ismessage) {
		...
		return ed25519_sign_internal(priv_key, signature, hashedmessage, SX_ED25519_DGST_SZ, 1);
	} else {
				...
				size_t message_length, const char *signature, int ismessage)
{
	...
	if (ismessage) {
		...
		return ed25519_verify_internal(pubkey, hashedmessage, SX_ED25519_DGST_SZ, signature, 1);
	}
